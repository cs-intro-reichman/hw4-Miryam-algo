...
public class ArrCharOps {
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        ...
        char [] concatArrs = new char [arr1.length + arr2.length];
        ...
        for (int j = 0; j < arr2.length; j++){
            concatArrs [arr1.length + j] = arr2 [j];
        }
        return concatArrs;
    }
    ...
    public static char[] subArray(char[] arr, int beginIndex, int endIndex) {
        ...
        int arrIndex = beginIndex;
        int SubArrIndex = 0;
        
        while (arrIndex < endIndex){
            subArr [SubArrIndex] = arr [arrIndex];
            arrIndex ++;
            SubArrIndex ++;
            }
        return subArr;
    ...
    public static long hashCode(char[] arr) {
        ...
        for (int i = 0; i < arr.length; i++){
            sumCode += arr[i] * Math.pow(7, n - i -1);
        }
        return sumCode;
    }
    ...
    public static int compareTo(String str1, String str2) {
        ...
        if (str1.length() < str2.length()){
            lengthForLoop = str1.length();
            checkLonger = -1;
        } else if (str1.length() > str2.length()){ 
            lengthForLoop = str2.length();
            checkLonger = 1;
        } else {
            lengthForLoop = str1.length();
            checkLonger = 0;
